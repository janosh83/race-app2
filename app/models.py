...
class Race(db.Model):
    ...
    bivak_1_latitude = db.Column(db.Float, nullable=True)
    bivak_1_longitude = db.Column(db.Float, nullable=True)
    bivak_2_name = db.Column(db.String(100), nullable=True)
    bivak_2_latitude = db.Column(db.Float, nullable=True)
    bivak_2_longitude = db.Column(db.Float, nullable=True)
    ...
    time_constraint_mode = db.Column(db.String(32), nullable=False, default='fixed')
    start_showing_offset_seconds = db.Column(db.Integer, nullable=True)
    end_showing_offset_seconds = db.Column(db.Integer, nullable=True)
    start_logging_offset_seconds = db.Column(db.Integer, nullable=True)
    end_logging_offset_seconds = db.Column(db.Integer, nullable=True)
...
class Registration(db.Model):
    ...
    start_showing_checkpoints_at = db.Column(db.DateTime, nullable=True)
    end_showing_checkpoints_at = db.Column(db.DateTime, nullable=True)
    start_logging_at = db.Column(db.DateTime, nullable=True)
    end_logging_at = db.Column(db.DateTime, nullable=True)
