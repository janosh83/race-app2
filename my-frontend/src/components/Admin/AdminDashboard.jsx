                        ...
                        <div className="mt-2 pt-2 border-top">
                          ...
                          <div className="mt-2 pt-2 border-top">
                            ...
                            <div>
                              ...
                              {selected.registration_driver_amount_cents ?? 2500}
                            </div>
                            <div>
                              <strong>{t('admin.dashboard.registrationCodriverAmountCents')}:</strong>{' '}
                              {selected.registration_codriver_amount_cents ?? 1500}
                            </div>
                          </div>
                          <div className="mt-2">
