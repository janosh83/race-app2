...
def add_test_data(test_app):
    ...
    with test_app.app_context():
        ...
        # Registrations
        reg1 = Registration(race_id=race1.id, team_id=team1.id, race_category_id=category.id, payment_confirmed=True)
        reg2 = Registration(race_id=race1.id, team_id=team2.id, race_category_id=category.id, payment_confirmed=True)
        reg3 = Registration(race_id=race1.id, team_id=team3.id, race_category_id=category.id, payment_confirmed=True)
        reg4 = Registration(race_id=race2.id, team_id=team4.id, race_category_id=category.id, payment_confirmed=True)
        reg5 = Registration(race_id=race2.id, team_id=team5.id, race_category_id=category.id, payment_confirmed=True)
